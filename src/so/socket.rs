...
impl Socket {
    ...
    pub fn start(&self) {
        match self.socket_type {
            Type::Server | Type::Publisher | Type::OutputChannel  => self.socket_handle.bind(self.socket_addr),
            Type::Client | Type::Subscriber | Type::InputChannel => self.socket_handle.connect(self.socket_addr),
        }.unwrap();
    }
